...
\begin{table*}
  ...
  \begin{tabular}{lllll}
    ...
    \midrule
    Regression Baseline     & $\mathbf{0.000}$ & $\mathbf{0.000}$ & $\mathbf{0.000}$ & $\mathbf{0.000}$ \\
