# Brian Elinsky: code pulled from:
# https://github.com/huggingface/transformers/blob/master/examples/tensorflow/language-modeling/run_mlm.py
# I've adapted parts of it to fit my use case.

# Copyright 2021 The HuggingFace Inc. team. All rights reserved.
# Licensed under the Apache License, Version 2.0 (the "License");
# http://www.apache.org/licenses/LICENSE-2.0

# Most common command to start training:
# python run_mlm.py
# --model_name_or_path distilbert-base-cased
# --output_dir <path/to/directory/for/saved/model>
# --train_file <path/to/train/dataset.txt>
# --max_seq_length 512
# --do_train
...
class SavePretrainedCallback(tf.keras.callbacks.Callback):
    ...
    # metadata to allow them to be loaded as a pretrained model in the future. This is a simple Keras callback
...
def main():
    ...
    # Sanity checks
    if data_args.train_file is None and data_args.validation_file is None:
    ...
    # Provide your own TXT training and evaluation files
    data_files = {}
    if data_args.train_file is not None:
    ...
    with training_args.strategy.scope():
        ...
        tf_eval_dataset = (
            tf.data.Dataset.from_generator(eval_generator, output_signature=eval_signature).with_options(options).batch(
